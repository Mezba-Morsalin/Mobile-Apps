    ...
    return (
        <div className='w-11/12 lg:w-10/12 mx-auto mt-18'>
            <div className='flex flex-col justify-center items-center gap-14'>
                ...
                <h2 className='text-6xl font-bold'><span className='bg-linear-to-r from-[#632EE3] to-[#9F62F2] bg-clip-text text-transparent leading-none'>Productive </span>Apps</h2>
